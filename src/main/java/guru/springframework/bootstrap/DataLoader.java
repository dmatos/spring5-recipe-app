...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        UnityOfMeasure eachUomOptional = unityOfMeasureService.findByDescription("Each");

        if(eachUomOptional == null){
            throw new RuntimeException("Expected UOM Not Found");
        }

        UnityOfMeasure tableSpoonUomOptional = unityOfMeasureService.findByDescription("Tablespoon");

        if(tableSpoonUomOptional == null){
            throw new RuntimeException("Expected UOM Not Found");
        }

        UnityOfMeasure teaSpoonUomOptional = unityOfMeasureService.findByDescription("Teaspoon");

        if(teaSpoonUomOptional == null){
            throw new RuntimeException("Expected UOM Not Found");
        }

        UnityOfMeasure dashUomOptional = unityOfMeasureService.findByDescription("Dash");

        if(dashUomOptional == null){
            throw new RuntimeException("Expected UOM Not Found");
        }

        UnityOfMeasure pintUomOptional = unityOfMeasureService.findByDescription("Pint");

        if(pintUomOptional == null){
            throw new RuntimeException("Expected UOM Not Found");
        }

        UnityOfMeasure cupsUomOptional = unityOfMeasureService.findByDescription("Cup");

        if(cupsUomOptional == null){
            throw new RuntimeException("Expected UOM Not Found");
        }

        //get optionals
        UnityOfMeasure eachUom = eachUomOptional;
        UnityOfMeasure tableSpoonUom = tableSpoonUomOptional;
        UnityOfMeasure teapoonUom = tableSpoonUomOptional;
        UnityOfMeasure dashUom = dashUomOptional;
        UnityOfMeasure pintUom = dashUomOptional;
        UnityOfMeasure cupsUom = cupsUomOptional;

        //get Categories
        Category americanCategoryOptional = categoryService.findByDescription("American");

        if(americanCategoryOptional == null){
            throw new RuntimeException("Expected Category Not Found");
        }

       Category mexicanCategoryOptional = categoryService.findByDescription("Mexican");

        if(mexicanCategoryOptional == null){
            throw new RuntimeException("Expected Category Not Found");
        }

        Category americanCategory = americanCategoryOptional;
        Category mexicanCategory = mexicanCategoryOptional;
